...
describe('transaction',() => {
    ...
    describe('input', () => {
        ...
        it('sets the amount field to sender wallets balance', () => {
            expect(transaction.input.amount).toEqual(senderWallet.balance);
        });

        it('sets the address to sender wallet public key', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('transaction output map is invalid', () => {

                it('returns false and logs the error' , () => {
                    transaction.outputMap[senderWallet.publicKey] = 90890;
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('subtracts the amount from the original sender wallet balance', () => {
            ...
            describe('and another update for the same recipient', () => {
                ...
                it('adds the value to be sum of all values', () => {
                    expect(transaction.outputMap[nextRecipient]).toEqual(nextAmount + addedAmount);
                });

                it('should amount the new amount from sender as well', () => {
